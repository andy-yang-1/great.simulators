 ...
 * Created on Mon Jul 25 19:48:57 BST 2016 by java2js
 * --------------------------------------------------
...
define(["jslib",
    "edu/sjtu/cs/controller",
    "edu/sjtu/cs/java2js",
    "edu/sjtu/cs/jsconsole",
    "edu/sjtu/cs/jscontrols/JSControl",
    "edu/sjtu/cs/jscontrols/ResetControl",
    "edu/sjtu/cs/jscontrols/StepControl",
    "java/awt",
    "java/lang",
    "java/math",
    "java/util",
    ...
    function (jslib,
        edu_sjtu_cs_controller,
        edu_sjtu_cs_java2js,
        edu_sjtu_cs_jsconsole,
        edu_sjtu_cs_jscontrols_JSControl,
        edu_sjtu_cs_jscontrols_ResetControl,
        edu_sjtu_cs_jscontrols_StepControl,
        java_awt,
        java_lang,
        java_math,
        java_util,
        ...
        var Steppable = edu_sjtu_cs_controller.Steppable;
        var JSCanvas = edu_sjtu_cs_java2js.JSCanvas;
        var JSElementList = edu_sjtu_cs_java2js.JSElementList;
        var JSImage = edu_sjtu_cs_java2js.JSImage;
        var JSProgram = edu_sjtu_cs_java2js.JSProgram;
        var JSConsole = edu_sjtu_cs_jsconsole.JSConsole;
        var JSControl = edu_sjtu_cs_jscontrols_JSControl.JSControl;
        var ResetControl = edu_sjtu_cs_jscontrols_ResetControl.ResetControl;
        var StepControl = edu_sjtu_cs_jscontrols_StepControl.StepControl;
